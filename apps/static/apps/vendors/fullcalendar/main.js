...
var FullCalendar = (function (exports) {
    ...
    */
    function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
        ...
        // help out EventApi from having auth modify props
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "classNames", {
            // NOTE: auth can't modify these because Object.freeze was called in event-def parsing
    ...
    */
    ...
    /*
    Detects when the auth clicks on an event within a DateComponent
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the auth's pointer
    ...
    */
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        function Popover() {
            ...
            // Triggered when the auth clicks *anywhere* in the document, for the autoHide feature
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by auth of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function (scrollStartEl) {
            return this.queryScrollEls(scrollStartEl).map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to auth-generated scrolls
                }
                return new ElementScrollGeomCache(el, false); // false = don't listen to auth-generated scrolls
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isInteracting = false; // is the auth validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the auth clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the auth selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require auth to hold down
